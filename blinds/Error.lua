SMODS.Blind {
    ...
    set_blind = function(self)
        ...
        local percent = pseudorandom('porkify_error_requirement', 10, 500)
        blind.effect.porkify_error_percent = percent
        local minimum, maximum = math.ceil(blind.chips * 0.1), math.floor(blind.chips * 5)
        ...
        local low, high = math.ceil(blind.dollars * 0.2), math.floor(blind.dollars * 2)
